        ...
        <SafeAreaView edges={['top']} style={{
            ...
            <ScrollView style={{
                ...
                <FlatList
                    ...
                    numColumns={2}
                    data={[{ name: t('Practice'), color: 'blue' }, { name: t('Students'), color: 'red' }, { name: t('Exams'), color: 'green' }, { name: t('Questions'), color: '#7aa' },{ name: t('Practice'), color: 'blue' }, { name: t('Students'), color: 'red' }, { name: t('Exams'), color: 'green' }, { name: t('Questions'), color: '#7aa' },]}
                    renderItem={({ item }) => {
                        return (
                            <>
                                <View style={{
