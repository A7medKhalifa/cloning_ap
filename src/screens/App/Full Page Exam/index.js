...
// import { AppRequired, COLORS, FONTS, images } from '.';
import { SafeAreaView } from 'react-native';
import { AppRequired, COLORS, FONTS, images } from 'src/constants';
const ViewTypes = {
    FULL: 0,
    HALF_LEFT: 1,
    HALF_RIGHT: 2,
...
export default class FullPageExam extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            visibleModal: false,
            percent: '',
            quizId: `this.props.route.params['quiz_id']`,
            quiz_name: `this.props.route.params['video_name']`,
            failed_video: `this.props.route.params['failed_video']`,
            pass_video: `this.props.route.params['pass_video']`,
            good_video: `this.props.route.params['good_video']`,
            very_good_video: `this.props.route.params['very_good_video']`,
            excellent_video: `this.props.route.params['excellent_video']`,
    ...
    render() {
        ...
        return (
            <NativeBaseProvider>
                ...
                <SafeAreaView style={{ backgroundColor: COLORS.primary, height: 10 }} />
                ...
                {this.state.loading == false &&
                    ...
                    this.state.loading == false && this.state.status == 'not_done' ? (
                        ...
                        <View
                            ...
                            <Image
                                style={{ width: '70%', height: height / 4, backgroundColor: '#f00' }}
                            ...
                            {this.state.arr.map((item) => (
                                <TouchableOpacity
                                    ...
                                    style={{
                                        ...
                                        height: 30,
                                        borderRadius: 50,
                                        backgroundColor: this.state.oldIndex == index ? COLORS.primary : '#FFF',
                                        justifyContent: 'center',
                                        alignItems: 'center',
                                        marginLeft: 5,
                                        elevation: 1,
                ...
                {this.state.connection_Status == 'offline' && <ViewConnectionMsg ConnectionEnter="لا يوجد اتصال بالأنترنت" />}
                {/* </Container> */}
            </NativeBaseProvider>
